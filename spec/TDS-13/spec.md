# TDS-13: Move ticket to Done and delete branch when dispatch PR merges

Generated from Jira on 2026-05-07T23:51:07.383Z.
...
|---|---|
| Key | TDS-13 |
| Title | Move ticket to Done and delete branch when dispatch PR merges |
| Type | Task |
| Status | To Do |
| Priority | Medium |
| Assignee | - |
...
| Labels | claude:pr |
| Components | - |
| Created | 2026-05-08T02:50:07.399+0300 |
| Updated | 2026-05-08T02:50:07.509+0300 |

## Description

Mirror of TDS-12 for the post-merge side: when a dispatch PR merges, transition the Jira ticket to Done and delete the per-ticket branch automatically.
